...
function InterviewApp() {
    ...
    return (
        <div className="interview-container w-full h-full flex flex-col justify-center items-center bg-slate-200 text-white hue-rotate-60 saturate-100">
            <div className="flex flex-row">
                <div className="p-12 text-center w-1/2 m-20 backdrop-blur-sm gap-20 rounded-3xl h-2/3">
                    <p className="text-2xl font-semibold my-10">Question</p>
                    {
                        gotQuestion ? (
                            <p className="mt-16 text-xl tracking-wider">{question}</p>
                        ) : (
                            <div className="flex flex-col items-center">
                                <Skeleton animation="wave" className="animate-pulse" width={300} sx={{ backgroundColor: "#343536" }} />
                                <Skeleton animation="wave" className="animate-pulse" width={200} sx={{ backgroundColor: "#343536" }} />
                                <Skeleton animation="wave" className="animate-pulse" width={300} sx={{ backgroundColor: "#343536" }} />
                                <Skeleton animation="wave" className="animate-pulse" width={200} sx={{ backgroundColor: "#343536" }} />
                                <Skeleton animation="wave" className="animate-pulse" width={300} sx={{ backgroundColor: "#343536" }} />
                            </div>
                ...
                <div className="flex flex-col items-center p-12 my-14 w-1/2 m-20 backdrop-blur-sm gap-14 rounded-3xl">
                    ...
                    {gotResponse ? (
                        ...
                        <div className="flex flex-col items-center">
                            <Skeleton animation="wave" className="animate-pulse" width={400} sx={{ backgroundColor: "#343536" }} />
                            <Skeleton animation="wave" className="animate-pulse" width={300} sx={{ backgroundColor: "#343536" }} />
                            <Skeleton animation="wave" className="animate-pulse" width={400} sx={{ backgroundColor: "#343536" }} />
                        </div>
                    )}
